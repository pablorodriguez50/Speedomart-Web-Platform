...
$mensaje_perfil = $_SESSION["mensaje_perfil"];
} else {
$mensaje_perfil = "";
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
                         ...
                         <?php } else if($cargo_usuario == 'personal'){ ?>
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
					            ...
					            <li> <a href="perfil.php?rut=<?php $rut_usuario ?>" ><i class="fa fa-user"></i> Perfil</a> </li>
...
?>
         	...
         	<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							 <h3>Editar Perfil :</h3>
                             <button onclick="location.href='home.php';" class="btn btn-default back-btn"><span class="fa fa-chevron-left"></span> Volver al Home</button>
						</div>
						<div class="form-body">
							<form action="procesarperfil.php"> 
                                ...
                                <div class="form-group"> 
                                   <label for="cargo">Seleccione el cargo :<br></label> 
                                    <div class="radio"> 
                                        <label> <input type="radio" id="cargo" disabled > personal </label> 
                                        <label> <input type="radio" id="cargo" checked="checked" value="administrador" name="cargo" required=""> admin </label> 
                                    </div>
                                </div>
                                <div class="form-group"> 
...
if (isset($mensaje_perfil)) {

if($mensaje_perfil!=NULL){
 echo "<div class='row'><div class='col-md-4 col-md-offset-4'><div class='alert alert-info alert-personalizada'  role='alert'>" .$mensaje_perfil. "</div></div></div>" ;
