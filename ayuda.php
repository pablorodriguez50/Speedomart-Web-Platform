            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="#" class="active" ><i class="fa fa-question-circle nav_icon"></i>Ayuda <span class="fa arrow"></span></a>
						</li>
			...
			<div class="main-page">
				<div class="row-one">
					...
					<div class="clearfix"> </div>	
				      ...
				      <h1 class="text-muted">Si necesita ayuda contactese con <b>speedomartsupport@gmail.cl</b>
                      o llame al numero <b>400 400 3000 </b>.</h1>
                      </div>
